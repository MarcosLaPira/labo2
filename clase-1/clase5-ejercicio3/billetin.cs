...
namespace clase4_ejercicio2._1
{
    ...
    public class Euro
    {
        ...
        public static void SetCotizacion(double cotizacionEuro)
        {
            Euro.cotizRespectDolar = cotizacionEuro;
        }
        #endregion
    ...
    public class Peso
    {
        ...
        public static void SetCotizacion(double cotizacionPeso)
        {
            Peso.cotizRespectDolar = cotizacionPeso;
        }
        #endregion
